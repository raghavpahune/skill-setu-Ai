    ...
    <Layout>
      <div data-demo="admin-dashboard-container">
        ...
        {adminTab === 'overview' && (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs p-6 mb-8">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-sm font-extrabold text-slate-900 dark:text-white">
                    AI Engine & External Ingestion Routing
                  </h3>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                  Workload-based AI routing with deterministic fallback and external connector telemetry.
                </p>
              </div>
              <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 space-y-2">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 space-y-1">
                  <div>Source: <span className="font-semibold text-slate-800 dark:text-slate-200">Adzuna India Live API</span></div>
                  <div>Policy: <span className="font-semibold text-slate-700 dark:text-slate-300">Fail-Closed in Production</span></div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 space-y-2">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 space-y-1">
                  <div>Source: <span className="font-semibold text-slate-800 dark:text-slate-200">Open Government Data API</span></div>
                  <div>Policy: <span className="font-semibold text-slate-700 dark:text-slate-300">Fail-Closed in Production</span></div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 space-y-2">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 space-y-1">
                  <div>Role: <span className="font-semibold text-slate-800 dark:text-slate-200">Authoritative Store</span></div>
                  <div>Fallback: <span className="font-semibold text-rose-600 dark:text-rose-400">None (Fail-Closed)</span></div>
                </div>
              </div>
            </div>
          </div>
